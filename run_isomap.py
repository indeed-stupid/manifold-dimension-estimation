...
Ks = [5, 10, 25, 50, 75, 100, 200, 300, 400, 500]
...
if True:
    ...
    np.savetxt("isomap_01.csv", ds_01, delimiter=",")
    np.savetxt("isomap_02.csv", ds_02, delimiter=",")
    np.savetxt("isomap_03.csv", ds_03, delimiter=",")
    np.savetxt("isomap_04.csv", ds_04, delimiter=",")
    np.savetxt("isomap_05.csv", ds_05, delimiter=",")
    np.savetxt("isomap_06.csv", ds_06, delimiter=",")
    np.savetxt("isomap_07.csv", ds_07, delimiter=",")
    np.savetxt("isomap_08.csv", ds_08, delimiter=",")
    np.savetxt("isomap_09.csv", ds_09, delimiter=",")
    np.savetxt("isomap_10.csv", ds_10, delimiter=",")
