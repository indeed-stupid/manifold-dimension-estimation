...
if True:
    ...
    np.savetxt("comparison_uniform_500_01.csv", ds_01, delimiter=",")
    np.savetxt("comparison_uniform_500_02.csv", ds_02, delimiter=",")
    np.savetxt("comparison_uniform_500_03.csv", ds_03, delimiter=",")
    np.savetxt("comparison_uniform_500_04.csv", ds_04, delimiter=",")
    np.savetxt("comparison_uniform_500_05.csv", ds_05, delimiter=",")
    np.savetxt("comparison_uniform_500_06.csv", ds_06, delimiter=",")
    np.savetxt("comparison_uniform_500_07.csv", ds_07, delimiter=",")
