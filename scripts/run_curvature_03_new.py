...
if True:
    ...
    n = 1000 # 
    K = int(n / 10)
    for R in [0.0001, 0.001, 0.01, 0.05, 0.1, 0.2, 0.5, 1, 2, 4]:
        for index in range(0, 100):
            sampler = CosSinSampler(n=n, d=d, k=R, sigma=0, seed=index, uniform=True)
    ...
    np.savetxt("c01_01.csv", ds_01, delimiter=",")
    np.savetxt("c01_02.csv", ds_02, delimiter=",")
    np.savetxt("c01_03.csv", ds_03, delimiter=",")
    np.savetxt("c01_04.csv", ds_04, delimiter=",")
    np.savetxt("c01_05.csv", ds_05, delimiter=",")
    np.savetxt("c01_06.csv", ds_06, delimiter=",")
    np.savetxt("c01_07.csv", ds_07, delimiter=",")
    np.savetxt("c01_08.csv", ds_08, delimiter=",")
    np.savetxt("c01_09.csv", ds_09, delimiter=",")
    np.savetxt("c01_10.csv", ds_10, delimiter=",")
    np.savetxt("c01_15.csv", ds_15, delimiter=",")
    np.savetxt("c01_16.csv", ds_16, delimiter=",")
    np.savetxt("c01_17.csv", ds_17, delimiter=",")
