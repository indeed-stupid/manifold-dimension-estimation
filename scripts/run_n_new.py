...
if True:
    ...
    np.savetxt("n_01.csv", ds_01, delimiter=",")
    np.savetxt("n_02.csv", ds_02, delimiter=",")
    np.savetxt("n_03.csv", ds_03, delimiter=",")
    np.savetxt("n_04.csv", ds_04, delimiter=",")
    np.savetxt("n_05.csv", ds_05, delimiter=",")
    np.savetxt("n_06.csv", ds_06, delimiter=",")
    np.savetxt("n_07.csv", ds_07, delimiter=",")
    np.savetxt("n_08.csv", ds_08, delimiter=",")
    np.savetxt("n_09.csv", ds_09, delimiter=",")
    np.savetxt("n_10.csv", ds_10, delimiter=",")
    np.savetxt("n_15.csv", ds_15, delimiter=",")
    np.savetxt("n_16.csv", ds_16, delimiter=",")
    np.savetxt("n_17.csv", ds_17, delimiter=",")
