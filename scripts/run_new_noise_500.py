...
if True:
    ...
    np.savetxt("comparison_noise_500_15.csv", ds_15, delimiter=",")
    np.savetxt("comparison_noise_500_16.csv", ds_16, delimiter=",")
    np.savetxt("comparison_noise_500_17.csv", ds_17, delimiter=",")
