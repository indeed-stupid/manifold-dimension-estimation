...
if True:
    ...
    np.savetxt("comparison_nonuniform_500_01.csv", ds_01, delimiter=",")
    np.savetxt("comparison_nonuniform_500_02.csv", ds_02, delimiter=",")
    np.savetxt("comparison_nonuniform_500_03.csv", ds_03, delimiter=",")
    np.savetxt("comparison_nonuniform_500_04.csv", ds_04, delimiter=",")
    np.savetxt("comparison_nonuniform_500_05.csv", ds_05, delimiter=",")
    np.savetxt("comparison_nonuniform_500_06.csv", ds_06, delimiter=",")
    np.savetxt("comparison_nonuniform_500_07.csv", ds_07, delimiter=",")
    np.savetxt("comparison_nonuniform_500_08.csv", ds_08, delimiter=",")
    np.savetxt("comparison_nonuniform_500_09.csv", ds_09, delimiter=",")
    np.savetxt("comparison_nonuniform_500_10.csv", ds_10, delimiter=",")
    np.savetxt("comparison_nonuniform_500_15.csv", ds_15, delimiter=",")
    np.savetxt("comparison_nonuniform_500_16.csv", ds_16, delimiter=",")
    np.savetxt("comparison_nonuniform_500_17.csv", ds_17, delimiter=",")
