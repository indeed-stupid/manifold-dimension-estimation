...
if True:
    ...
    for noise_level in range(0, 10):
        for index in range(0, 100):
            sampler = SphereSampler(n=n, d=d, p=p, R=R, seed=index, sigma = 0.01 * noise_level)
    ...
    np.savetxt("noise_01.csv", ds_01, delimiter=",")
    np.savetxt("noise_02.csv", ds_02, delimiter=",")
    np.savetxt("noise_03.csv", ds_03, delimiter=",")
    np.savetxt("noise_04.csv", ds_04, delimiter=",")
    np.savetxt("noise_05.csv", ds_05, delimiter=",")
    np.savetxt("noise_06.csv", ds_06, delimiter=",")
    np.savetxt("noise_07.csv", ds_07, delimiter=",")
    np.savetxt("noise_08.csv", ds_08, delimiter=",")
    np.savetxt("noise_09.csv", ds_09, delimiter=",")
    np.savetxt("noise_10.csv", ds_10, delimiter=",")
    np.savetxt("noise_15.csv", ds_15, delimiter=",")
    np.savetxt("noise_16.csv", ds_16, delimiter=",")
    np.savetxt("noise_17.csv", ds_17, delimiter=",")
